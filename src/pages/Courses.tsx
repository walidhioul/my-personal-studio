...
type ApiLevel = "A1" | "A2" | "B1" | "B2" | "C1" | "C2";
...
const levelSubtitles = {
  en: {
    A1: "Start your English journey with fundamental skills",
    A2: "Build on basics with everyday communication",
    B1: "Handle most situations with growing confidence",
    B2: "Communicate fluently in complex contexts",
    C1: "Express yourself with precision and nuance",
    C2: "Achieve near-native mastery",
  },
  ar: {
    A1: "ابدأ رحلتك الإنجليزية بالمهارات الأساسية",
    A2: "ابنِ على الأساسيات مع التواصل اليومي",
    B1: "تعامل مع معظم المواقف بثقة متزايدة",
    B2: "تواصل بطلاقة في سياقات معقدة",
    C1: "عبّر عن نفسك بدقة وتفصيل",
    C2: "حقق إتقانًا شبيهًا بالمتحدثين الأصليين",
  },
};
